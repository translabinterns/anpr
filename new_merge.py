...
def main():
    ...
    with open("/home/mustufa/output.txt", "w") as f:
        f.write("")
    ...
    while i < 1:
        ...
        cv2.imwrite('/home/mustufa/images/img' + str(i) + '.png', image)
        i += 1
        # del(camera)
        ...
        for file in glob.glob(path):
         ...
         #   df.to_csv('Dataset_VehicleNo.csv')
          #  print(text_no)
            ...
            if not text_no:
                exit()
            with open("/home/mustufa/output.txt", "a") as f:
    ...
    try:
        ...
        if connection.is_connected():
            ...
            mySql_insert_query = """LOAD DATA LOCAL INFILE '/home/mustufa/output.txt' INTO TABLE car_info(plate_number); """
